...
// Mock beneficiary data for current year (2024)
const conservationBeneficiariesData = [
...
const socioEconomicBeneficiariesData = [
...
// Current vs Remaining beneficiaries data
const currentVsRemainingData = [
  { name: "Current Beneficiaries", value: 5200, color: "#54D12B" },
  { name: "Remaining Target", value: 2800, color: "#EF4444" },
];
...
export default function AnalyticsPageContent() {
  ...
  // Calculate total beneficiaries for the selected category
  const getTotalBeneficiaries = () => {
    const data =
      selectedCategory === "conservation"
        ? conservationBeneficiariesData
        : socioEconomicBeneficiariesData;
    return data.reduce((sum, item) => sum + item.beneficiaries, 0);
  };

  // Calculate current month beneficiaries
  const getCurrentMonthBeneficiaries = () => {
    const data =
      selectedCategory === "conservation"
        ? conservationBeneficiariesData
        : socioEconomicBeneficiariesData;
    const currentMonth = new Date().getMonth();
    return data[currentMonth]?.beneficiaries || 0;
  };
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="p-6">
                  ...
                  <p className="text-gray-500 text-sm mt-1">Current Year</p>
                </Card>
                ...
                <Card className="p-6">
                  ...
                  <span className="text-3xl font-bold text-gray-900">
                    {getCurrentMonthBeneficiaries().toLocaleString()}
                  </span>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <PieChart>
                        <Pie
                          ...
                          dataKey="value"
                        >
                          {currentVsRemainingData.map((entry, index) => (
